;KillKeys - gl-ES localization by Alexander De Sousa (xandy.lua@gmail.com)
...
LangString L10N_RUNNING_INSTALL   ${LANG} "${APP_NAME} está en funcionamento. Quérelo pechar?"
LangString L10N_RUNNING_UNINSTALL ${LANG} "${APP_NAME} está en funcionamento. Quérelo pechar?$\nSe seleccionas Non, ${APP_NAME} eliminarase completamente cando reinicies."
