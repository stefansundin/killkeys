...
#define L10N_ABOUT_KEYS1       L"Keys disabled when not in fullscreen:"
#define L10N_ABOUT_KEYS2       L"Keys disabled when in fullscreen:"
#define L10N_ABOUT_KEYS3       L"Enable "APP_NAME" to see which keys will be blocked."
